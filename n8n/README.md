...
The workflow foundation now uses one live RSS ingestion path while keeping extraction, synthesis, and database writes mocked. This lets the source side of the workflow be tested without taking on every integration at once.
